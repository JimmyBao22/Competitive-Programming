...
public class FirstelementatleastX {
	...
	public static void main(String[] args) throws IOException, FileNotFoundException {
		...
		//BufferedReader in = new BufferedReader(new FileReader("FirstelementatleastX"));
	...
	static class SegTree {
		...
		public int comp(long y) {
			return comp(y, 0, 0, size);
		}
		
		public int comp(long y, int x, int lx, int rx) {
			...
			int m = (lx + rx)/2;
			int one = comp(y, 2*x+1, lx, m);
			if (one == -1) return comp(y, 2*x+2, m, rx);
			return one;
		}
